...
import net.badnuker.dsmod.item.custom.Brush;
...
public class ModItems {
    public static final Item STELLAR_SYMPHONY = registerItems("stellar_symphony", new StellarSymphony(new Item.Settings().maxCount(1)));
    public static final Item SWITCH = registerItems("switch", new Switch(new Item.Settings().maxCount(1)));
    public static final Item BRUSH = registerItems("brush", new Brush(new Item.Settings().maxCount(1)));
